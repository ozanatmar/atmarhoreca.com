...
export default async function BrandPage({ params }: Props) {
  ...
  const { data: products } = await supabase
    .from('products')
    .select('id, name, slug, sku, price, images, stock_status, requires_confirmation, brand_id, tags, views, brand:brands(name, default_requires_confirmation, lead_time_note)')
